...
public class FeedsAdapter extends RecyclerView.Adapter<FeedsAdapter.MyViewHolder> {
    ...
    Context context;
    public FeedsAdapter(Context context, ArrayList<e.par.connectingmist_30.Newsfeed_Notice.FeedItem>feedItems){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        e.par.connectingmist_30.Newsfeed_Notice.FeedItem current=feedItems.get(position);
